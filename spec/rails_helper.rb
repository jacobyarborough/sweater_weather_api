...
def forecast_response
  {
    "data": {
        ...
        "attributes": {
            "current_weather": {
                "datetime": "2022-01-18 10:38:36 -0700",
            ...
            "hourly_weather": [
                {
                    "time": "2022-01-18 10:00:00 -0700",
                    "temperature": 44.78,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 11:00:00 -0700",
                    "temperature": 45.41,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 12:00:00 -0700",
                    "temperature": 45.64,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 13:00:00 -0700",
                    "temperature": 46.85,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 14:00:00 -0700",
                    "temperature": 48.15,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 15:00:00 -0700",
                    "temperature": 48.49,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 16:00:00 -0700",
                    "temperature": 47.32,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                },
                {
                    "time": "2022-01-18 17:00:00 -0700",
                    "temperature": 45.32,
                    "conditions": "overcast clouds",
                    "icon": "04d"
                }
...
def books 
 ...
 :docs=>
  [{:key=>"/works/OL4930574W",
    ...
    :has_fulltext=>false,
    :edition_count=>3,
    :edition_key=>["OL17801719M", "OL17665953M", "OL2663740M"],
    :publish_date=>["1984"],
    :publish_year=>[1984],
   ...
   {:key=>"/works/OL19500062W",
    ...
    :contributor=>["Luft, Werner.", "Photovoltaics Safety Conference (2nd : 1988 : Denver, Colo.)", "Solar Energy Research Institute."],
