  ...
  describe "GET /forecast" do
    ...
    context 'when the request is valid' do 
      it 'returns the weather forecast for denver' do 
        ...
        expect(forecast.count).to eq(10) # need to check
        ...
        expect(forecast[:attributes][:current_weather][:humidity]).to be_an(Integer) # need to check
        expect(forecast[:attributes][:current_weather]).to have_key(:uvi)
        expect(forecast[:attributes][:current_weather][:uvi]).to be_an(Integer) # need to check
        expect(forecast[:attributes][:current_weather]).to have_key(:visibility)
        expect(forecast[:attributes][:current_weather][:visibility]).to be_an(Integer) # need to check
        expect(forecast[:attributes][:current_weather]).to have_key(:conditions)
        expect(forecast[:attributes][:current_weather][:conditions]).to be_an(Integer) # this is the first 'description' field from ther weather data as given by OpenWeatehr
        ...
        forecast[:attributes][:daily_weather].each do |day|
          expect(day[:attributes]).to have_key(:date) 
          expect(day[:attributes][:date]).to be_a(String)
          expect(day[:attributes]).to have_key(:sunrise) 
          expect(day[:attributes][:sunrise]).to be_a(String)
          expect(day[:attributes]).to have_key(:sunset) 
          expect(day[:attributes][:sunset]).to be_a(String)
          expect(day[:attributes]).to have_key(:max_temp) 
          expect(day[:attributes][:max_temp]).to be_a(Float)
          expect(day[:attributes]).to have_key(:min_temp) 
          expect(day[:attributes][:min_temp]).to be_a(Float)
          expect(day[:attributes]).to have_key(:conditions) 
          expect(day[:attributes][:conditions]).to be_a(String)
          expect(day[:attributes]).to have_key(:icon) 
          expect(day[:attributes][:icon]).to be_a(String)
        end 
        ...
        forecast[:attributes][:hourly_weather].each do |hour|
          expect(hour[:attributes]).to have_key(:time) 
          expect(hour[:attributes][:time]).to be_a(String)
          expect(hour[:attributes]).to have_key(:temperature) 
          expect(hour[:attributes][:temperature).to be_a(Float)
          expect(hour[:attributes]).to have_key(:conditions) 
          expect(hour[:attributes][:conditions]).to be_a(String)
          expect(hour[:attributes]).to have_key(:icon) 
          expect(hour[:attributes][:icon]).to be_a(String)
        end 
      end 
